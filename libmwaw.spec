...
export LANG=C
export SOURCE_DATE_EPOCH=1557103171
export AR=gcc-ar
...
cp COPYING.LGPL %{buildroot}/usr/share/package-licenses/libmwaw/COPYING.LGPL
cp COPYING.MPL %{buildroot}/usr/share/package-licenses/libmwaw/COPYING.MPL
%make_install
...
/usr/lib64/libmwaw-0.3.so.3.0.15

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/libmwaw/COPYING.LGPL
/usr/share/package-licenses/libmwaw/COPYING.MPL
