...
Source0  : https://dev-www.libreoffice.org/src/libmwaw-0.3.17.tar.xz
...
%prep
%setup -q -n libmwaw-0.3.17
cd %{_builddir}/libmwaw-0.3.17
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1601313857
...
cp %{_builddir}/libmwaw-0.3.17/COPYING.LGPL %{buildroot}/usr/share/package-licenses/libmwaw/6ec1f37ffe429f1cd0585eb50658a1877da1658b
cp %{_builddir}/libmwaw-0.3.17/COPYING.MPL %{buildroot}/usr/share/package-licenses/libmwaw/98fc4d9117e318bd75af8a544c8a0238c3334186
%make_install
