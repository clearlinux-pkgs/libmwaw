...
Source0  : https://dev-www.libreoffice.org/src/libmwaw-0.3.21.tar.xz
...
%prep
%setup -q -n libmwaw-0.3.21
cd %{_builddir}/libmwaw-0.3.21
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702019757
...
/usr/lib64/libmwaw-0.3.so.3.0.21
